  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      meta: {
        ...
        'twitter:url': 'https://latipun7.github.io/webcomponents-webpack-ts/',
        'twitter:title': AppConfig.name,
        'twitter:description': AppConfig.description,
        'twitter:image':
          'https://latipun7.github.io/webcomponents-webpack-ts/assets/android-chrome-512x512.png',
        'twitter:image:alt': `${AppConfig.name} logo`,
        ogURL: {
          property: 'og:url',
          content: 'https://latipun7.github.io/webcomponents-webpack-ts/',
        },
    ...
    new FaviconsWebpackPlugin({
      ...
      favicons: {
        ...
        theme_color: '#08d9d6',
        background: '#eaeaea',
        start_url: 'https://latipun7.github.io/webcomponents-webpack-ts/',
        display: 'standalone',
      },
    }),
    new GenerateSW({
